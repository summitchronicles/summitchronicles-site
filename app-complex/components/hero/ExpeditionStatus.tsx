...
export default function ExpeditionStatus({
  ...
  const getRealTrainingData = () => {
    ...
    const totalActivities =
      stravaStats.runs.count +
      stravaStats.hikes.count +
      stravaStats.rides.count;
    const totalDistance = Math.round(
      stravaStats.runs.distance_km +
        stravaStats.hikes.distance_km +
        stravaStats.rides.distance_km
    );
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        >
          <div className="flex items-center space-x-2">
            ...
            <h3 className="font-semibold text-charcoal group-hover:text-alpineBlue transition-colors duration-300">
              Current Position
            </h3>
          </div>
        ...
        >
          <div className="flex items-center space-x-2">
            ...
            <h3 className="font-semibold text-charcoal group-hover:text-summitGold transition-colors duration-300">
              Next Summit
            </h3>
          </div>
          <div className="relative overflow-hidden">
        ...
        >
          <div className="flex items-center space-x-2">
            ...
            <h3 className="font-semibold text-charcoal group-hover:text-successGreen transition-colors duration-300">
              Training Progress
            </h3>
          </div>
                ...
                <motion.div
                  className={clsx(
                    ...
                    training.status === 'on-track' &&
                      'bg-successGreen/10 text-successGreen group-hover:bg-successGreen/20',
                    training.status === 'ahead' &&
                      'bg-glacierBlue/10 text-glacierBlue group-hover:bg-glacierBlue/20',
                    training.status === 'behind' &&
                      'bg-warningOrange/10 text-warningOrange group-hover:bg-warningOrange/20'
                  )}
                  whileHover={{ scale: 1.05 }}
                >
                  <motion.div
        ...
        >
          <div className="flex items-center space-x-2">
            ...
            <h3 className="font-semibold text-charcoal group-hover:text-glacierBlue transition-colors duration-300">
              Weather Conditions
            </h3>
          </div>
          <div className="relative overflow-hidden">
            ...
            <motion.div
              className={clsx(
                ...
                conditions.status === 'poor' &&
                  'bg-warningOrange/10 text-warningOrange group-hover:bg-warningOrange/20',
                conditions.status === 'dangerous' &&
                  'bg-dangerRed/10 text-dangerRed group-hover:bg-dangerRed/20'
              )}
              whileHover={{ scale: 1.05 }}
            >
              <motion.div
      ...
      >
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}
        >
          <motion.div className="absolute inset-0 bg-gradient-to-r from-alpineBlue via-blue-600 to-glacierBlue opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
          <motion.div
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}
        >
          <motion.div className="absolute inset-0 bg-gradient-to-r from-summitGold via-yellow-400 to-orange-400 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
          <motion.div
            animate={{
              rotate: [0, 10, -10, 0],
              scale: [1, 1.1, 1],
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}
        >
          <motion.div className="absolute inset-0 bg-gradient-to-r from-white to-glacierBlue/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
          <motion.div
            animate={{
              y: [0, -2, 0],
              scale: [1, 1.05, 1],
          ...
          <span className="relative z-10 group-hover:text-glacierBlue transition-colors duration-300">
            Weather Forecast
          </span>
        </motion.button>
        ...
        <div className="flex items-center space-x-2 px-4 py-3 bg-successGreen/5 border border-successGreen/20 rounded-xl">
          <motion.div
            ...
            transition={{ duration: 2, repeat: Infinity }}
          />
          <span className="text-xs font-medium text-successGreen">
            Live Data
          </span>
        </div>
      </motion.div>
