...
export default function TrainingCalendar({
  ...
  const exportCalendar = () => {
    ...
    alert(
      'Calendar export functionality coming soon! For now, take a screenshot or print this page.'
    );
  };
          ...
          >
            {day.date > 0 && (
              <div className="h-full p-1 flex flex-col">
                ...
                <div
                  className={`w-full h-1 rounded-full ${getTypeColor(day.type)} mb-1`}
                ></div>
                ...
                <div className="flex-1 flex flex-col justify-center">
                  ...
                  {day.duration && (
                    <p className="text-white/50 text-xs mt-1">{day.duration}</p>
                  )}
                </div>
              </div>
            )}
      ...
      <div className="space-y-3">
        ...
        <div className="pt-2 border-t border-white/10">
          <p className="text-white/50 text-xs">
            Click on any day to mark it as completed. Border color indicates
            intensity level.
          </p>
        </div>
      </div>
