      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-xl text-white/70 max-w-3xl mx-auto">
            Building a global community of mountaineers, adventure seekers, and
            brands who value authentic expedition content.
          </p>
        </motion.div>
            ...
            >
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-6 hover:bg-white/10 hover:border-white/20 transition-all duration-300">
                ...
                <div className="flex items-center justify-center mb-4">
                  <div
                    className={`p-3 rounded-2xl bg-gradient-to-br from-white/10 to-white/5 ${stat.color}`}
                  >
