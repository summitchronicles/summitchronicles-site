...
const expeditions: Expedition[] = [
  ...
  },
  {
    ...
    status: 'future',
    story:
      'The ultimate goal. Everything has been building toward this moment. Two years of preparation, training, and gaining experience on the previous summits. This is why I started the Seven Summits journey.',
    elevation: '8,849m',
...
const getDifficultyColor = (difficulty: Expedition['difficulty']) => {
  switch (difficulty) {
    ...
    case 'Very Technical':
      return 'text-alpineBlue';
    case 'Extremely Technical':
...
export default function ExpeditionTimeline() {
  ...
  const [selectedPhoto, setSelectedPhoto] = useState<ExpeditionPhoto | null>(
    null
  );
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-xl text-white/60 max-w-3xl mx-auto">
            A chronological journey through each summit attempt, from my first
            peak to the ultimate Everest goal. Real stories, lessons learned,
            and the authentic challenges of high-altitude mountaineering.
          </p>
        </motion.div>
                  ...
                  >
                    ...
                    {expedition.stats && (
                      <div className="grid grid-cols-3 gap-4 mb-6 p-4 bg-white/5 rounded-lg">
                        ...
                        <div className="text-center">
                          <div className="text-lg font-bold text-alpineBlue">
                    ...
                    {expedition.lessons.length > 0 &&
                      expedition.lessons[0] !== 'Currently preparing...' &&
                      expedition.lessons[0] !== 'The ultimate test awaits...' &&
                      expedition.lessons[0] !== 'Future expedition...' && (
                        <div>
