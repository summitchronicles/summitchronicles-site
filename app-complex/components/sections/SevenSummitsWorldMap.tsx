...
const sevenSummits: Summit[] = [
  {
    ...
    description:
      'The highest peak in North America, known for extreme weather and technical climbing challenges.',
    difficulty: 'Extreme',
    bestSeason: 'May - July',
  },
  {
    ...
    description:
      'The highest peak in South America and the highest mountain outside of Asia.',
  ...
  },
  {
    ...
    description:
      'The highest peak in Europe, located in the Caucasus Mountains.',
    difficulty: 'Moderate',
  ...
  },
  {
    ...
    description:
      "The world's highest mountain, the ultimate challenge for any mountaineer.",
    difficulty: 'Extreme',
  ...
  },
  {
    ...
    description:
      'The highest peak in Antarctica, extremely remote and technically challenging.',
    difficulty: 'Extreme',
  ...
  },
  {
    ...
    description:
      'The highest peak in Oceania and one of the most technically difficult summits.',
    difficulty: 'Extreme',
...
const getStatusColor = (status: Summit['status']) => {
  switch (status) {
    ...
    case 'planned':
      return 'text-alpineBlue bg-alpineBlue/10 border-alpineBlue/20';
    case 'future':
      return 'text-stoneGray bg-stoneGray/10 border-stoneGray/20';
    default:
      return 'text-stoneGray bg-stoneGray/10 border-stoneGray/20';
  }
};
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-xl text-white/60 max-w-3xl mx-auto mb-8">
            Follow my progress across all seven continents. Each peak represents
            months of training, planning, and the ultimate test of endurance and
            determination.
          </p>
          ...
          <div className="flex items-center justify-center gap-8 mb-8">
            <div className="text-center">
              <div className="text-3xl font-bold text-summitGold">
                {completedCount}/7
              </div>
            ...
            <div className="text-center">
              <div className="text-3xl font-bold text-alpineBlue">
          ...
          >
            <div className="flex items-start justify-between mb-6">
              <div>
                ...
                <p className="text-white/60">
                  {selectedSummit.continent} • {selectedSummit.country}
                </p>
              </div>
              <button
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
              <div>
                ...
                <p className="text-xl font-bold text-summitGold">
                  {selectedSummit.elevation}
                </p>
              </div>
              <div>
                <h4 className="text-sm font-semibold text-white/80 mb-2">
                ...
                <p
                  className={clsx(
                    'text-xl font-bold',
                    getDifficultyColor(selectedSummit.difficulty)
                  )}
                >
              ...
              <div>
                ...
                <p className="text-xl font-bold text-glacierBlue">
          ...
          {[
            {
              status: 'completed',
              label: 'Completed',
              count: sevenSummits.filter((s) => s.status === 'completed')
                .length,
            },
            {
              status: 'in-progress',
              label: 'In Progress',
              count: sevenSummits.filter((s) => s.status === 'in-progress')
                .length,
            },
            {
              status: 'planned',
              label: 'Planned',
              count: sevenSummits.filter((s) => s.status === 'planned').length,
            },
            {
              status: 'future',
              label: 'Future',
              count: sevenSummits.filter((s) => s.status === 'future').length,
            },
          ].map((item) => (
            <div
              key={item.status}
            ...
            >
              ...
              <div>
                ...
                <div className="text-white/60 text-sm">
                  {item.count} summit{item.count !== 1 ? 's' : ''}
                </div>
              </div>
            </div>
          ))}
