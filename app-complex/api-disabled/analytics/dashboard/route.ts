...
const DashboardQuerySchema = z.object({
  timeRange: z
    ...
    .default('24h'),
  metric: z
    .enum(['overview', 'visitors', 'ai', 'content', 'realtime'])
    .optional()
    .default('overview'),
});
      ...
      const mockData = {
        ...
        ai: {
          interactions: Array.from({ length: 20 }, (_, i) => ({
            ...
            user_rating:
              Math.random() > 0.3 ? Math.floor(Math.random() * 2) + 4 : null,
            was_helpful: Math.random() > 0.2,
            error_occurred: Math.random() < 0.06,
          })),
          topics: [
            {
              topic_name: 'Everest Training',
              category: 'training',
              total_questions: 45,
              avg_satisfaction: 4.3,
            },
            {
              topic_name: 'Gear Recommendations',
              category: 'gear',
              total_questions: 38,
              avg_satisfaction: 4.1,
            },
            {
              topic_name: 'K2 Route Planning',
              category: 'expeditions',
              total_questions: 29,
              avg_satisfaction: 4.5,
            },
            {
              topic_name: 'High Altitude Health',
              category: 'health',
              total_questions: 24,
              avg_satisfaction: 4.2,
            },
            {
              topic_name: 'Technical Climbing',
              category: 'training',
              total_questions: 18,
              avg_satisfaction: 4.0,
            },
            {
              topic_name: 'Weather Conditions',
              category: 'expeditions',
              total_questions: 15,
          ...
          satisfaction: Array.from({ length: 50 }, () => ({
            ...
            question_category: ['training', 'gear', 'expeditions', 'health'][
        ...
        content: {
          popularPages: [
            ...
            },
            {
              ...
              page_title: 'Ask AI',
              total_views: 89,
              avg_time_on_page: 167,
              rank: 3,
            },
            {
              page_url: '/gear',
              page_title: 'Gear Reviews',
              total_views: 76,
          ...
          engagement: Array.from({ length: 20 }, (_, i) => ({
            page_url: ['/training', '/expeditions', '/ask', '/gear', '/'][
              i % 5
            ],
        ...
        realtime: {
          activeSessions: Array.from({ length: 5 }, (_, i) => ({
            current_page: ['/', '/training', '/ask', '/expeditions', '/gear'][
              i
            ],
          ...
          recentActivity: Array.from({ length: 10 }, (_, i) => ({
            page_url: ['/', '/training', '/ask', '/expeditions', '/gear'][
              Math.floor(Math.random() * 5)
            ],
