    ...
    <div className="min-h-screen bg-gradient-to-b from-black via-gray-900 to-black flex items-center justify-center">
      <div className="max-w-4xl mx-auto px-6 text-center">
        ...
        >
          ...
          <span className="text-successGreen font-bold text-lg">
        ...
        >
          <p className="text-xl md:text-2xl text-white/80 mb-8 max-w-2xl mx-auto">
            My 2013 recovery led to mountains, marathons, and exploration.
            <br />
        ...
        >
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-6">
            <h3 className="text-xl font-bold text-successGreen mb-3">
              Start Local
            </h3>
        ...
        >
          ...
          <p className="text-white/80 mb-6">
            Get weekly training tips, gear reviews, and motivation straight from
            base camp.
          </p>
