-- Drop only training_plans specific objects
...
-- Create update function ONLY if it doesn't exist (it already exists from blog tables)
...
-- Storage policies (safely drop and recreate)
DO $$
BEGIN
