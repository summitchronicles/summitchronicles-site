...
> Historical implementation record: the public `/design-system` showcase was
> retired in July 2026. Shared design-system components remain in the app.
...
- Retired: `app/components/molecules/FormField.tsx` unused showcase-era form wrapper
- `app/components/molecules/StatusBadge.tsx` - Status badges with semantic color variants
- Retired: `app/design-system/page.tsx` public component showcase
- Retired: `tests/e2e/design-system.spec.ts` visual regression suite
