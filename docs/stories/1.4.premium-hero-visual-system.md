...
> Historical implementation record: the original standalone `HeroSection`
> component was retired in July 2026 after the live pages adopted route-specific
> cinematic heroes.
...
- **Retired Hero Component**: `/app/components/organisms/HeroSection.tsx`
