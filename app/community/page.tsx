...
export const metadata: Metadata = {
  ...
  description: 'Join a supportive community of adventurers following the Mount Everest expedition journey. Share achievements, ask questions, and celebrate together.',
  openGraph: {
    title: 'Summit Chronicles Community - Join Fellow Adventurers',
    description: 'Connect with supporters, share your journey, and be part of expedition celebrations and community challenges.',
  }
}
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-12">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <h1 className="text-4xl font-light text-spa-charcoal">Community Hub</h1>
            </div>
            <p className="text-xl text-spa-charcoal/80 max-w-3xl mx-auto leading-relaxed">
              Connect with fellow adventurers supporting the Mount Everest expedition journey. 
              Share achievements, ask questions, and celebrate systematic preparation together.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
            {communityStats.map(({ label, value, icon: Icon }) => (
              <div key={label} className="bg-white/90 backdrop-blur-sm rounded-xl p-6 border border-spa-stone/10 shadow-sm text-center">
        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="text-center mb-12">
            <div className="flex items-center justify-center gap-2 mb-4">
              ...
              <h2 className="text-3xl font-light text-spa-charcoal">Community Guidelines</h2>
            </div>
            <p className="text-spa-charcoal/70">
              Our community thrives on mutual support, authentic sharing, and positive encouragement
            </p>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {communityGuidelines.map((guideline, index) => (
                <div key={index} className="flex items-start gap-3">
                  ...
                  <p className="text-spa-charcoal/80 leading-relaxed">{guideline}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="py-16 bg-gradient-to-br from-spa-charcoal to-alpine-blue text-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <h2 className="text-3xl font-light">Ready to Join the Adventure?</h2>
          </div>
          <p className="text-white/80 mb-8 leading-relaxed">
            Be part of a community that celebrates systematic preparation, authentic storytelling, 
            and the journey toward ambitious goals. Your support and encouragement help fuel the expedition.
          </p>
          ...
          <div className="mt-8 text-sm text-white/60">
            <p>2,847+ community members • Weekly challenges • Milestone celebrations</p>
          </div>
        </div>
      </section>
    </DefaultLayout>
