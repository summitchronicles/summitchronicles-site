...
import { Activity, Mail, Settings, CheckCircle, AlertCircle, RefreshCw } from 'lucide-react'
    ...
    <div className="min-h-screen gradient-peak py-8">
      <div className="max-w-4xl mx-auto px-6">
        <div className="mb-8">
          ...
          <p className="text-slate-600">Manage your personal integrations and data connections.</p>
        </div>
          ...
          <div className="mountain-card p-6 elevation-shadow">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="font-semibold text-slate-900">Strava Integration</h3>
                  <p className="text-sm text-slate-600">Personal activity data</p>
                </div>
              </div>
          ...
          <div className="mountain-card p-6 elevation-shadow">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="font-semibold text-slate-900">Newsletter (Buttondown)</h3>
                  <p className="text-sm text-slate-600">Email subscriber management</p>
                </div>
              </div>
              <div className="flex items-center space-x-2">
                {newsletterConnected ? (
        ...
        <div className="mountain-card p-8 elevation-shadow">
          <h2 className="text-xl font-semibold text-slate-900 mb-6">Setup Instructions</h2>
          
          <div className="space-y-6">
            <div>
              <h3 className="font-medium text-slate-900 mb-3">Strava Setup</h3>
              <ol className="list-decimal list-inside space-y-2 text-sm text-slate-600">
                <li>Go to <a href="https://www.strava.com/settings/api" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">Strava API Settings</a></li>
                <li>Create a new API application with your site details</li>
                <li>Copy the Client ID and Client Secret to the fields above</li>
                <li>Set your authorization callback URL to: <code className="bg-slate-100 px-2 py-1 rounded">your-domain.com/api/strava/callback</code></li>
                <li>Click "Connect Strava" to authenticate your personal account</li>
              </ol>
            </div>

            <div>
              <h3 className="font-medium text-slate-900 mb-3">Buttondown Setup</h3>
              <ol className="list-decimal list-inside space-y-2 text-sm text-slate-600">
                <li>Sign up for a <a href="https://buttondown.email" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">Buttondown account</a></li>
                <li>Go to Settings → API and copy your API key</li>
                <li>Paste the API key in the field above</li>
                <li>Click "Connect Buttondown" to enable newsletter functionality</li>
