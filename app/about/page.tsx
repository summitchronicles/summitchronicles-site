          ...
          <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
            ...
            >
              <p className="text-xl md:text-2xl font-light text-gray-300 leading-relaxed mb-8">
                ...
                chapter is physiotherapy, strength work, and a disciplined
              ...
              >
                <div className="space-y-6">
                  ...
                  <p className="text-lg text-gray-400 font-light leading-relaxed">
                    Bedridden with tuberculosis. The doctors said walking would
                    be a challenge. My lungs were compromised, my body weak. But
                    in that hospital bed, I made a decision:
