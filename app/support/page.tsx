              ...
              return (
                ...
                >
                  <div className="bg-glass-panel border border-white/5 p-8 rounded-2xl text-center group-hover:border-summit-gold/30 transition-all duration-300 relative overflow-hidden">
                    ...
                    <div className="text-xs font-mono tracking-widest uppercase text-gray-400 mb-2">
                      {metric.label}
                    </div>
                    <div
                      className={`inline-block px-2 py-1 text-[10px] font-mono font-bold tracking-widest uppercase rounded border ${
                        metric.status === 'ACTIVE'
                          ? 'border-blue-900 text-blue-400 bg-blue-900/10'
                          : metric.status === 'RESEARCHED'
                            ? 'border-green-900 text-green-400 bg-green-900/10'
                            : metric.status === 'PLANNING'
                              ? 'border-orange-900 text-orange-400 bg-orange-900/10'
              ...
              >
                <div className="grid md:grid-cols-4 gap-8 items-start">
                  ...
                  <div className="text-right border-l border-white/5 pl-8 hidden md:block">
                    ...
                    <div className="text-xs text-gray-400 leading-relaxed max-w-[150px] ml-auto">
                      {category.source}
                    </div>
                  </div>
                </div>
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-300 font-light leading-relaxed max-w-3xl mx-auto">
              The journey from tuberculosis recovery to Everest represents more
              than just climbing—it's about systematic preparation, pushing
              boundaries, and proving what's possible through discipline.
            </p>
            ...
            <div className="bg-glass-panel border border-summit-gold/20 rounded-2xl p-10 text-left backdrop-blur-md relative">
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-sm font-mono tracking-widest text-summit-gold-400 uppercase">
                    Current Phase: Preparation
                  </span>
                </div>
                <p className="text-gray-300 leading-relaxed text-lg font-light">
                  <strong className="text-white font-medium">
                    Currently researching expedition logistics and finalizing
                    equipment lists.
                  </strong>
                  Total expedition cost estimated between $70,000-$110,000 based
                  on Elite Expeditions pricing.
                </p>
                <div className="bg-summit-gold-900/20 border border-summit-gold-900/50 p-4 rounded text-sm text-gray-300">
                  Support at this stage accelerates preparation timelines and
                  secures critical training slots.
                </div>
              </div>
            </div>
