  ...
  const insights = [
    {
      ...
      excerpt:
        "Three weeks of poor sleep, declining performance, and questioning everything. Here's what I learned about overtraining and how data saved my expedition dreams.",
    ...
    },
    {
      ...
      excerpt:
        'Hanging upside down in a crevasse simulator taught me more than any textbook. Here are the real lessons from learning to rescue my future teammates.',
    ...
    },
    {
      ...
      excerpt:
        'My "waterproof" gloves weren\'t, my backup headlamp died, and my nutrition strategy was terrible. Expensive lessons from a winter ascent.',
    ...
    },
    {
      ...
      excerpt:
        'I told myself I was pushing hard in training. Then I looked at my actual power output and heart rate data. The numbers revealed uncomfortable truths.',
    ...
    },
    {
      ...
      excerpt:
        "At 14,000 feet with a pounding headache and nausea, your mind becomes your worst enemy. Here's how I've learned to manage the psychological challenge.",
    ...
    },
    {
      ...
      excerpt:
        "Every failed summit attempt, every gear mistake, every training session that went wrong. Here's why I share the unglamorous side of mountaineering.",
        ...
        <section className="py-20 gradient-peak text-white">
          <div className="max-w-4xl mx-auto px-6 text-center space-y-6">
            <H1 className="text-4xl md:text-6xl font-bold">
              My Climbing Insights
            </H1>
            <BodyLarge className="text-white/90 max-w-2xl mx-auto">
              Real stories from my Seven Summits journey. The victories,
              failures, and everything I've learned along the way to Mount
              Everest.
            </BodyLarge>
          </div>
        </section>
          ...
          {selectedCategory === 'All' && (
            <div className="mb-12">
              <div className="text-center mb-8">
                <H2>Latest Story</H2>
                <Body className="text-spa-charcoal/70">
                  My most recent insights from the mountain
                </Body>
              </div>
                ...
                <div className="grid md:grid-cols-2 gap-8 items-center">
                  ...
                  <div className="bg-gradient-to-br from-alpine-blue to-summit-gold rounded-xl p-8 text-white text-center">
                    ...
                    <Body className="text-white/90 text-sm">
                      No sugar-coating, no hero narratives. Just real
                      experiences from someone learning to climb big mountains.
                    </Body>
                  </div>
                </div>
              </Card>
              ...
              .map((insight) => (
                ...
                >
                  <Card
                    variant="elevated"
                    padding="lg"
                    className="h-full group-hover:shadow-spa-medium transition-all duration-300"
                  >
                    <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              ...
              <div className="space-y-3">
                ...
                <Body className="text-spa-charcoal/80">
                  Weekly insights from my Everest training, including the
                  struggles, breakthroughs, and data that drives every decision.
                </Body>
              </div>
              <Button
                variant="primary"
            ...
            >
              ...
              <div className="space-y-3">
                ...
                <Body className="text-spa-charcoal/80">
                  Real-time data from my preparation for the world's highest
                  mountain. Every workout, every metric, every lesson learned.
                </Body>
              </div>
          ...
          <div className="mt-16 text-center">
            <Card variant="premium" padding="lg" className="max-w-2xl mx-auto">
              <div className="space-y-4">
                ...
                <Body className="text-spa-charcoal/80 text-sm leading-relaxed">
                  These stories aren't about being a hero or selling you
                  something. They're about sharing what I've learned so others
                  can learn from my mistakes and maybe avoid some expensive
                  lessons. Every failure here has made me a better climber and a
                  better person.
                </Body>
