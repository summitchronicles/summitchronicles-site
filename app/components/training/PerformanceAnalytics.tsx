...
interface PerformanceData {
  ...
  unit: string
  category: 'cardiovascular' | 'strength' | 'endurance' | 'recovery' | 'technical'
...
export function PerformanceAnalytics() {
  ...
  const performanceData: PerformanceData[] = [
    {
      ...
      benchmark: 55,
      recommendations: ['Maintain current training intensity', 'Add high-altitude simulation sessions']
    },
    {
      id: '2',
      ...
      lastUpdated: '2024-12-15',
      benchmark: 50,
      recommendations: ['Excellent recovery capacity', 'Continue current training load']
    },
    {
      id: '3',
      ...
      benchmark: 4.5,
      recommendations: ['Add more strength training sessions', 'Focus on functional power movements']
    },
    {
      id: '4',
    ...
    },
    {
      ...
      benchmark: 8.5,
      recommendations: ['Practice ice climbing techniques', 'More altitude simulation needed']
    }
  ]
  ...
  const insights: AnalyticsInsight[] = [
    {
      ...
      description: 'Your VO2 max has reached an excellent level for high-altitude performance',
    ...
    },
    {
      ...
      description: 'Power-to-weight ratio is below target for technical climbing sections',
    ...
    },
    {
      ...
      description: 'Ice climbing proficiency needs improvement before Everest attempt',
  ...
  const getTrendColor = (trend: PerformanceData['trend'], category: string) => {
    ...
    const downIsBetter = ['Resting Heart Rate', 'Lactate Threshold'].includes(category)
    
    if (trend === 'up') return downIsBetter ? 'text-red-600' : 'text-green-600'
    if (trend === 'down') return downIsBetter ? 'text-green-600' : 'text-red-600'
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
        <div>
          <h3 className="text-2xl font-semibold text-gray-900">Performance Analytics</h3>
          <p className="text-gray-600 mt-1">Comprehensive analysis of your training metrics and progress</p>
        </div>
            ...
            >
              ...
              <div className="flex items-start justify-between mb-4">
                <div>
                  ...
                  <p className="text-xs text-gray-500 uppercase tracking-wide">{metric.category}</p>
                </div>
              ...
              <div className="mb-4">
                ...
                <div className="flex items-center gap-2">
                  <TrendIcon className={cn('w-4 h-4', getTrendColor(metric.trend, metric.name))} />
                  <span className={cn('text-sm font-medium', getTrendColor(metric.trend, metric.name))}>
