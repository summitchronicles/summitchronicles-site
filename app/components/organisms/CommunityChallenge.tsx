  ...
  const challenges: Challenge[] = [
    {
      ...
      description:
        'Complete at least 20 training sessions this month following systematic progression principles.',
    ...
    },
    {
      ...
      description:
        'Share weekly reflections on training challenges and victories in the community.',
    ...
    },
    {
      ...
      description:
        'Join the systematic base building phase with structured workouts and community support.',
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-spa-charcoal/70 max-w-2xl mx-auto">
            Join fellow adventurers in structured challenges that build
            consistency, community connection, and systematic progress toward
            expedition goals.
          </p>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <p className="text-spa-charcoal/70 text-sm">
                Follow systematic approaches with clear goals and milestones
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-spa-charcoal/70 text-sm">
                Get featured in newsletters and receive exclusive content
              </p>
            </div>
          </div>
        </div>
