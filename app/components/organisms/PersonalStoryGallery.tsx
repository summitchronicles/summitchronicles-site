...
const SAMPLE_ACHIEVEMENTS: Achievement[] = [
  {
    ...
    description:
      'First successful summit of a major glaciated peak, completing the standard Disappointment Cleaver route in challenging weather conditions.',
    date: '2024-03-22',
    ...
    photos: [
      {
        ...
        caption: 'Summit success at sunrise',
        location: 'Mount Rainier Summit',
      },
      {
        url: '/api/placeholder/800/600',
        caption: 'Technical ice climbing section',
        location: 'Disappointment Cleaver',
      },
      {
        url: '/api/placeholder/800/600',
        caption: 'Team celebration at summit',
        location: 'Mount Rainier Summit',
      },
    ],
    metrics: [
    ...
    story:
      'Mount Rainier represented a crucial milestone in my mountaineering journey. The combination of technical ice climbing, high-altitude exposure, and glacier travel provided the perfect training ground for Himalayan objectives. Despite challenging weather conditions with 60mph winds and -18°C temperatures, our team successfully navigated the Disappointment Cleaver route, demonstrating both individual competence and team coordination essential for bigger mountains.',
  ...
  },
  {
    ...
    description:
      'Led international team to successful summit of Island Peak (6,189m) in the Everest region, serving as preparation for Mount Everest.',
    date: '2024-06-15',
    ...
    photos: [
      {
        url: '/api/placeholder/800/600',
        caption: 'Island Peak summit with Everest backdrop',
        location: 'Island Peak Summit',
      },
      {
        url: '/api/placeholder/800/600',
        caption: 'Technical headwall climbing',
        location: 'Island Peak Headwall',
      },
      {
        url: '/api/placeholder/800/600',
        caption: 'Team at Everest Base Camp',
    ...
    story:
      'Island Peak provided invaluable experience in the Everest region, combining high-altitude climbing with complex logistics and team management. Leading a diverse international team through technical terrain at extreme altitude tested both climbing skills and leadership capabilities. The expedition included comprehensive acclimatization rotations, technical skills workshops, and cultural immersion in Sherpa communities, creating a holistic preparation experience for Mount Everest.',
    certifications: [
  ...
  },
  {
    ...
    description:
      'Completed solo traverse of major Cascade peaks over 30 days, demonstrating endurance and self-sufficiency in wilderness environments.',
    date: '2024-08-10',
    ...
    photos: [
      {
        url: '/api/placeholder/800/600',
        caption: 'Solo camp below Mount Baker',
        location: 'Mount Baker',
      },
      {
        url: '/api/placeholder/800/600',
        caption: 'Glacier crossing with full pack',
        location: 'Cascade Glaciers',
      },
      {
        url: '/api/placeholder/800/600',
        caption: 'Final summit celebration',
...
const SAMPLE_TESTIMONIALS: Testimonial[] = [
  {
    ...
    content:
      'Outstanding mountaineer with exceptional technical skills and natural leadership abilities. Demonstrated remarkable composure and decision-making under pressure during our Island Peak expedition.',
    rating: 5,
  ...
  },
  {
    ...
    content:
      'Trained with this athlete for 8 months. Their systematic approach to preparation and unwavering commitment to safety protocols make them an ideal expedition teammate.',
    rating: 5,
  ...
  },
  {
    ...
    content:
      'Professional, dedicated, and authentic. Represents our brand values perfectly through genuine passion for mountaineering and commitment to environmental stewardship.',
    rating: 5,
...
const SAMPLE_MEDIA: MediaCoverage[] = [
  {
    ...
    url: '#',
    description:
      'In-depth profile covering training methodology and expedition preparation for Mount Everest attempt.',
  ...
  },
  {
    ...
    url: '#',
    description:
      'Technical interview discussing innovative training approaches for high-altitude mountaineering.',
    thumbnail: '/api/placeholder/300/200',
  },
  {
    id: '3',
    ...
    url: '#',
    description:
      '45-minute conversation about psychological preparation and risk management in mountaineering.',
    thumbnail: '/api/placeholder/300/200',
  },
];
...
export const PersonalStoryGallery: React.FC<PersonalStoryGalleryProps> = ({
  className,
}) => {
  const [activeSection, setActiveSection] = useState<
    'story' | 'achievements' | 'testimonials' | 'media'
  >('story');
  ...
  const nextImage = () => {
    if (selectedAchievement) {
      setCurrentImageIndex(
        (prev) => (prev + 1) % selectedAchievement.photos.length
      );
    }
  };
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-spa-charcoal/80 max-w-3xl mx-auto leading-relaxed">
            A comprehensive showcase of mountaineering experience, technical
            competence, and community recognition that demonstrates readiness
            ...
            <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-8 border border-spa-stone/10 shadow-sm">
              <div className="prose prose-lg max-w-none">
                ...
                <div className="space-y-6 text-spa-charcoal/80 leading-relaxed">
                  <p>
                    My mountaineering journey began not with grand aspirations
                    of Everest, but with a simple desire to explore the
                    mountains surrounding Seattle. What started as weekend
                    hiking quickly evolved into a deeper passion for
                    high-altitude environments and technical climbing
                    challenges.
                  </p>

                  <p>
                    The transformation from casual hiker to serious mountaineer
                    required systematic skill development, physical
                    conditioning, and mental preparation. Each peak taught
                    valuable lessons: Mount Baker introduced glacier travel,
                    Mount Rainier demonstrated the importance of weather
                    assessment, and the Cascade Range traverse proved the value
                    of self-sufficiency and endurance.
                  </p>

                  <blockquote className="border-l-4 border-alpine-blue pl-6 italic text-xl text-alpine-blue my-8">
                    "Mountains have a way of teaching humility, patience, and
                    respect for natural forces. Each summit is less about
                    conquest and more about understanding."
                  </blockquote>

                  <p>
                    International experience in Nepal's Khumbu region provided
                    crucial exposure to Himalayan conditions, high-altitude
                    physiology, and expedition logistics. Leading diverse teams
                    through technical terrain at extreme altitude developed
                    leadership skills essential for major expeditions.
                  </p>

                  <p>
                    The Mount Everest expedition represents the culmination of
                    years of systematic preparation, not just physical and
                    technical, but also mental and spiritual. It's an
                    opportunity to test every aspect of mountaineering
                    competence while contributing to scientific research and
                    inspiring others to pursue their own extraordinary goals.
                  </p>

                  <div className="bg-gradient-to-br from-spa-mist/20 to-spa-cloud/20 rounded-xl p-6 mt-8">
                    <h4 className="text-lg font-medium text-spa-charcoal mb-4">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <p className="text-sm text-spa-charcoal/70">
                          Every decision prioritizes team safety and responsible
                          risk management in mountain environments.
                        </p>
                      </div>
                      <div>
                        <h5 className="font-medium text-spa-charcoal mb-2">
                        ...
                        <p className="text-sm text-spa-charcoal/70">
                          Committed to Leave No Trace principles and supporting
                          conservation efforts in mountain regions.
                        </p>
                      </div>
                      <div>
                        <h5 className="font-medium text-spa-charcoal mb-2">
                        ...
                        <p className="text-sm text-spa-charcoal/70">
                          Using expeditions as platforms for education,
                          inspiration, and supporting local communities.
                        </p>
                      </div>
                      <div>
                        <h5 className="font-medium text-spa-charcoal mb-2">
                        ...
                        <p className="text-sm text-spa-charcoal/70">
                          Every expedition provides opportunities for skill
                          development and sharing knowledge with others.
                        </p>
                      </div>
                    </div>
                  </div>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex gap-1">
                          {achievement.photos.slice(0, 3).map((_, idx) => (
                            <div
                              key={idx}
                              className="w-2 h-2 bg-spa-stone/30 rounded-full"
                            />
                          ))}
                        </div>
                      </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8">
              {SAMPLE_TESTIMONIALS.map((testimonial) => (
                <div
                  key={testimonial.id}
                  className="bg-white/90 backdrop-blur-sm rounded-xl p-6 border border-spa-stone/10 shadow-sm"
                >
                  <div className="flex items-center gap-1 mb-4">
                    {[...Array(testimonial.rating)].map((_, idx) => (
                      <Star
                        key={idx}
                        className="w-4 h-4 text-summit-gold fill-current"
                      />
                    ))}
                  </div>
                ...
                >
                  <div className="flex items-start gap-6">
                    <div className="w-24 h-16 bg-spa-mist/20 rounded-lg flex-shrink-0 flex items-center justify-center">
                      {media.type === 'video' ? (
                        <Play className="w-6 h-6 text-alpine-blue" />
                      ) : media.type === 'podcast' ? (
                        <Camera className="w-6 h-6 text-alpine-blue" />
                      ) : (
              ...
              <div className="relative aspect-video bg-gradient-to-br from-spa-mist to-spa-cloud">
                ...
                <div className="absolute bottom-4 left-4 bg-white/90 backdrop-blur-sm rounded-lg p-3">
                  ...
                  <div className="text-xs text-spa-charcoal/60">
                    ...
                    {selectedAchievement.photos.length}
                  </div>
                </div>
              </div>
                ...
                {selectedAchievement.metrics && (
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-6">
                    {selectedAchievement.metrics.map((metric, idx) => (
                      <div
                        key={idx}
                        className="text-center p-4 bg-spa-mist/10 rounded-lg"
                      >
