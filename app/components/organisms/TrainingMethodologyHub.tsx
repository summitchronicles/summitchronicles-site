...
const SAMPLE_WORKOUTS: WorkoutPlan[] = [
  {
    ...
    phase: 'base-building',
    description:
      'Build aerobic capacity and muscular endurance essential for high-altitude climbing. This foundational workout prepares your cardiovascular system for extended periods of exertion at elevation.',
    exercises: [
      {
        name: 'Dynamic Warm-up',
        duration: '10 minutes',
        notes: 'Focus on hip mobility and ankle preparation',
      },
      {
        name: 'Zone 2 Incline Walking',
        duration: '45 minutes',
        notes: '15-20% grade, maintain conversational pace',
      },
      {
        name: 'Step-ups with Pack',
        sets: 3,
        reps: '20 each leg',
        notes: 'Use 20-30lb pack, focus on control',
      },
      {
        ...
        reps: '10-20-30-20-10',
        rest: '90 seconds',
        notes: 'Simulate altitude stress',
      },
      {
        name: 'Cool-down Stretch',
        duration: '15 minutes',
        notes: 'Focus on calves, hips, and shoulders',
      },
    ],
    progression: [
      {
        week: 1,
        focus: 'Adaptation',
        modifications: ['Start with 15lb pack', 'Reduce grade to 12%'],
      },
      {
        week: 2,
        focus: 'Building',
        modifications: ['Increase to 20lb pack', 'Full 15% grade'],
      },
      {
        week: 4,
        focus: 'Peak',
        modifications: ['30lb pack', '20% grade', 'Add 15 minutes duration'],
      },
    ],
    equipment: [
      'Treadmill or steep trail',
      'Weighted pack',
      'Step platform',
      'Heart rate monitor',
    ],
  ...
  },
  {
    ...
    phase: 'strength',
    description:
      'Develop climbing-specific strength through compound movements that mirror mountaineering demands. Emphasizes core stability, unilateral strength, and power endurance.',
    exercises: [
      {
        ...
        reps: '6-8',
        rest: '3 minutes',
        notes: 'Focus on control, full ROM',
      },
      {
        ...
        reps: '8 each leg',
        rest: '90 seconds',
        notes: 'Use assistance as needed',
      },
      {
        name: 'Farmer Carries',
        sets: 3,
        duration: '40 seconds',
        rest: '2 minutes',
        notes: 'Heavy weight, perfect posture',
      },
      {
    ...
    progression: [
      {
        week: 1,
        focus: 'Form mastery',
        modifications: ['Bodyweight movements', 'Longer rest periods'],
      },
      {
        week: 3,
        focus: 'Load increase',
        modifications: ['Add weight', 'Reduce rest by 15 seconds'],
      },
      {
        week: 6,
        focus: 'Peak strength',
        modifications: ['Maximum weight', 'Add complexity variations'],
      },
    ],
    equipment: [
      'Pull-up bar',
  ...
  },
  {
    ...
    description:
      'Practice essential mountaineering techniques in controlled environment. Focus on rope work, anchor building, and emergency procedures.',
    exercises: [
      {
        name: 'Knot Practice Session',
        duration: '20 minutes',
        notes: 'Figure-8, clove hitch, prusik, munter',
      },
      {
        name: 'Anchor Building',
        duration: '30 minutes',
        notes: 'Practice SERENE principles',
      },
      {
        name: 'Crevasse Rescue Setup',
        duration: '40 minutes',
        notes: 'Full system practice with pack',
      },
      {
        name: 'Crampon Technique',
        duration: '20 minutes',
        notes: 'French, German, American techniques',
      },
      {
        name: 'Emergency Scenarios',
        duration: '10 minutes',
        notes: 'Random scenario response drills',
      },
    ],
    progression: [
      {
        week: 1,
        focus: 'Basic skills',
        modifications: ['Individual techniques', 'No time pressure'],
      },
      {
        week: 2,
        focus: 'Integration',
        modifications: ['Combine skills', 'Light time pressure'],
      },
      {
        week: 4,
        focus: 'Mastery',
        modifications: ['Full scenarios', 'Cold/wind simulation'],
      },
    ],
    equipment: [
      'Rope',
...
export const TrainingMethodologyHub: React.FC<TrainingMethodologyHubProps> = ({
  className,
}) => {
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-spa-charcoal/80 max-w-3xl mx-auto leading-relaxed">
            Systematic training approaches developed through years of
            mountaineering preparation. Each methodology includes detailed
            progression, equipment requirements, and recovery protocols.
          </p>
        </div>
        ...
        <div className="space-y-6">
          {filteredWorkouts.map((workout) => (
            <div
              key={workout.id}
              className="bg-white/90 backdrop-blur-sm rounded-xl border border-spa-stone/10 overflow-hidden shadow-sm"
            >
              {/* Workout Header */}
                ...
                <div className="p-6 space-y-8">
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      {workout.exercises.map((exercise, index) => (
                        <div
                          key={index}
                          className="flex items-start gap-4 p-4 bg-spa-mist/10 rounded-lg"
                        >
                  ...
                  <div className="grid md:grid-cols-2 gap-8">
                    ...
                    <div>
                      ...
                      <div className="space-y-3">
                        {workout.progression.map((prog, index) => (
                          <div
                            key={index}
                            className="p-4 bg-spa-cloud/20 rounded-lg"
                          >
                            <div className="font-medium text-spa-charcoal mb-2">
                              Week {prog.week}: {prog.focus}
                            </div>
                    ...
                    <div className="space-y-6">
                      ...
                      <div>
                        <h4 className="text-lg font-medium text-spa-charcoal mb-2">
                          Recovery
                        </h4>
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {workout.equipment.map((item, index) => (
                            <span
                              key={index}
                              className="px-2 py-1 bg-spa-stone/20 text-spa-charcoal/70 rounded text-sm"
                            >
                              {item}
                            </span>
                          ))}
        ...
        {filteredWorkouts.length === 0 && (
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-medium text-spa-charcoal mb-2">
              No training methodologies found
            </h3>
