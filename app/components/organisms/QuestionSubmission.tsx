  ...
  const categories: QuestionCategory[] = [
    {
      ...
      description:
        'Training methodologies, workout plans, and progression questions',
      icon: HelpCircle,
      color: 'blue',
    },
    {
      ...
      description:
        'Equipment recommendations, gear reviews, and purchasing advice',
      icon: Tag,
      color: 'green',
    },
    {
      ...
      description:
        'Route planning, logistics, permits, and expedition strategies',
      icon: MessageCircle,
      color: 'purple',
    },
    {
      ...
      description:
        'Mindset, motivation, fear management, and psychological aspects',
      icon: HelpCircle,
      color: 'amber',
    },
  ];
        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="bg-gradient-to-br from-emerald-50 to-white rounded-2xl p-8 border border-emerald-200 text-center">
            ...
            <p className="text-spa-charcoal/70 mb-6 leading-relaxed">
              Thank you for your question! It will be reviewed and potentially
              featured in upcoming newsletter Q&A sections or community
              discussions. You'll be notified if your question is selected for a
              detailed response.
            </p>
      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-spa-charcoal/70 max-w-2xl mx-auto">
            Have questions about training, gear, expedition planning, or mental
            preparation? Submit your questions for potential feature in
            newsletters or community Q&A sessions.
          </p>
        </div>
        ...
        <div className="bg-gradient-to-br from-spa-mist/20 to-white rounded-2xl p-8 border border-spa-stone/10">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <label
                htmlFor="question"
                className="block text-sm font-medium text-spa-charcoal mb-3"
              >
                Your Question
              </label>
              <textarea
              ...
              <div className="mt-2 text-xs text-spa-charcoal/60">
                Be specific and detailed to help provide the most useful
                response
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white/50 rounded-xl p-6 border border-spa-stone/10">
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-xs text-spa-charcoal/60">
                  Featured in Week 4 Newsletter
                </span>
              </div>
              <h4 className="font-medium text-spa-charcoal mb-2">
                "How do you balance cardio and strength training during base
                building?"
              </h4>
              <p className="text-sm text-spa-charcoal/70">
                Sarah M. asked about systematic progression through training
                phases...
              </p>
            </div>
            ...
            <div className="bg-white/50 rounded-xl p-6 border border-spa-stone/10">
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-xs text-spa-charcoal/60">
                  Featured in Week 3 Newsletter
                </span>
              </div>
              <h4 className="font-medium text-spa-charcoal mb-2">
                "What's the most important gear investment for high-altitude
                training?"
              </h4>
              <p className="text-sm text-spa-charcoal/70">
                David C. inquired about essential equipment for expedition
                preparation...
              </p>
            </div>
          </div>
