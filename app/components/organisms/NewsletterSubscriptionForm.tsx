    ...
    return (
      <div className={cn(
        ...
        <Button 
          ...
          className={cn(
            variant === 'cta' && 'text-white hover:text-white/80'
          )}
        >
    ...
    <div className={cn('space-y-6', className)}>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className={cn(
          ...
          <div className="flex-1">
            <Input
              ...
              className={cn(
                'w-full',
                variant === 'cta' && 'bg-white/10 border-white/30 text-white placeholder:text-white/60'
              )}
            />
          </div>
          ...
          <Button
            ...
            className={cn(
              ...
              variant === 'cta' && 'bg-white text-spa-charcoal hover:bg-white/90'
            )}
          >
            {status === 'loading' ? (
        ...
        <p className={cn(
          ...
          By subscribing, you agree to receive weekly expedition updates and training insights. 
      ...
      {variant === 'sidebar' && (
        <div className="pt-4 border-t border-spa-stone/20">
          <h4 className="text-sm font-medium text-spa-charcoal mb-3">What you'll get:</h4>
          <ul className="space-y-2">
            {benefits.map(({ text }) => (
              <li key={text} className="flex items-start gap-2 text-xs text-spa-charcoal/70">
