...
export function SponsorRecognition({
  ...
  const getCategoryColor = (category: Sponsor['category']) => {
    switch (category) {
      case 'community':
        return 'text-summit-gold';
      case 'training':
        return 'text-alpine-blue';
      case 'gear':
        return 'text-spa-charcoal';
      case 'safety':
      ...
      >
        <div className="text-center mb-6">
          <Body className="text-sm text-spa-charcoal/60 italic">
            "Every summit reached is a testament to the community that believes
            in the climb"
          </Body>
        </div>
  ...
  return (
    <section
      className={`py-16 bg-gradient-to-br from-spa-mist/20 to-white ${className}`}
    >
      <div className="max-w-6xl mx-auto px-6">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        {sponsor.featured && (
                          <div className="text-xs text-summit-gold font-medium">
                            Featured Partner
                          </div>
                        )}
                      </div>
        ...
        >
          <Body className="text-sm text-spa-charcoal/60 italic max-w-2xl mx-auto">
            "The summit is never reached alone. Every step is supported by those
            who believe in the journey, the preparation, and the safe return
            home."
          </Body>
          ...
          <div className="pt-4">
            <Body className="text-xs text-spa-charcoal/50">
              ...
              <span className="text-alpine-blue ml-1">
