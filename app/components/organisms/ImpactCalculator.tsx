...
const expeditionCosts: ImpactItem[] = [
  ...
  },
  {
    ...
    description: 'International travel, accommodation, and expedition logistics',
    cost: 6500,
    icon: Calculator,
...
export const ImpactCalculator: React.FC = () => {
  ...
  const totalExpeditionCost = expeditionCosts.reduce((sum, item) => sum + item.cost, 0)
            ...
            <div className="space-y-6">
              ...
              <div className="bg-spa-mist rounded-lg p-6 space-y-4">
                <div className="flex items-center justify-between">
                  <span className="text-spa-slate">Expedition Progress Impact</span>
                ...
                <div className="w-full bg-white rounded-full h-3">
                  <div 
                    ...
                    style={{ width: `${Math.min(impactPercentage * 100, 100)}%` }}
                  />
                </div>
              ...
              {/* Specific Impacts */}
              <div className="space-y-3">
                <h4 className="font-medium text-spa-charcoal">Your ${donationAmount} Enables:</h4>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-spa-elevated border border-spa-cloud">
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-r from-alpine-blue to-summit-gold rounded-lg p-6 text-white text-center">
                <div className="text-sm opacity-90 mb-1">Total Expedition Investment</div>
                <div className="text-4xl font-bold">${totalExpeditionCost.toLocaleString()}</div>
              </div>
                    ...
                    <div key={index} className="space-y-2">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-3">
                          ...
                          <span className="font-medium text-spa-charcoal">{item.category}</span>
                        </div>
                      ...
                      <p className="text-sm text-spa-slate">{item.description}</p>
                    </div>
                  )
                })}
              </div>
              ...
              <div className="bg-spa-mist rounded-lg p-4">
                ...
                <p className="text-sm text-spa-slate leading-relaxed">
                  ...
                  Monthly financial reports detail exactly how contributions advance expedition goals.
                </p>
              </div>
            </div>
          </div>
