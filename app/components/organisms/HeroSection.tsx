    ...
    <section className={`relative min-h-screen flex items-center justify-center overflow-hidden ${className || ''}`}>
      ...
      >
        ...
        >
          ...
          >
            <Button variant="summit" size="lg" asChild className="shadow-spa-medium font-montserrat">
              <Link href="/support">
                <motion.div
                  whileHover={{ rotate: 5 }}
          ...
          <motion.div
            ...
            transition={{ type: "spring", stiffness: 400, damping: 17 }}
          >
            <Button variant="ghost" size="lg" asChild className="group font-montserrat">
              <Link href="/about">
                <motion.div
                  animate={{ rotate: 360 }}
        ...
        >
          ...
          >
            ...
            <div className="font-oswald text-3xl font-bold text-spa-charcoal mb-2">127km</div>
          ...
          >
            ...
            <div className="font-oswald text-3xl font-bold text-spa-charcoal mb-2">2,840m</div>
            <div className="font-montserrat text-spa-slate">Elevation Gained</div>
          </motion.div>
          ...
          >
            ...
            <div className="font-oswald text-3xl font-bold text-spa-charcoal mb-2">Week 12</div>
