...
export function CommunityFeed() {
  ...
  const posts: CommunityPost[] = [
    {
      ...
      content:
        "Just completed my first 20-mile training hike with a 35lb pack! Sunith's systematic approach to building endurance has been incredible. The weekly progression really works. Thank you for the inspiration! 🏔️",
      ...
      achievement: {
        ...
        description:
          'Completed with 35lb pack following systematic training approach',
      },
    },
    {
      id: '2',
      ...
      content:
        "Question for the community: What's your favorite recovery method after intense training days? I've been following the training methodology but looking for additional recovery techniques. Any recommendations?",
    ...
    },
    {
      ...
      content:
        "Sending massive encouragement to everyone participating in this week's community challenge! Remember, every step counts toward your bigger goals. We're all climbing our own mountains together! 💪",
      timestamp: '1 day ago',
      type: 'encouragement',
      likes: 45,
      comments: 12,
    ...
    },
    {
      ...
      content:
        "Gear Review: Just tested the new altitude training mask mentioned in last week's newsletter. Solid build quality and really helps simulate high-altitude conditions. Worth the investment for serious expedition prep.",
  ...
  const filters = [
    { id: 'all', label: 'All Posts', count: posts.length },
    {
      id: 'achievement',
      label: 'Achievements',
      count: posts.filter((p) => p.type === 'achievement').length,
    },
    {
      id: 'question',
      label: 'Questions',
    ...
    },
    {
      id: 'encouragement',
      label: 'Encouragement',
      count: posts.filter((p) => p.type === 'encouragement').length,
    },
  ];
      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-spa-charcoal/70">
            Latest updates, achievements, and discussions from the Summit
            Chronicles community
          </p>
        </div>
          ...
          {filteredPosts.map((post) => {
            ...
            return (
              ...
              >
                      ...
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        {post.author.badge && (
                          <Badge
                            className={cn(
                              'text-xs',
                              getBadgeColor(post.author.badge)
                            )}
                          >
                            {post.author.badge}
                          </Badge>
                ...
                {/* Post Content */}
                <div className="mb-4">
                  <p className="text-spa-charcoal leading-relaxed">
                    {post.content}
                  </p>
                </div>
