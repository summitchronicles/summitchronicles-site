...
import { GlassCard, StatusIndicator, ContentSkeleton } from "@/app/components/ui";
...
export default function SmartSearch({
            ...
            const mockResults: SearchResult[] = [
              {
                ...
                snippet: 'Comprehensive training plan for Mount Everest including fitness, altitude preparation...',
              ...
              },
              {
                ...
                snippet: 'Must-have equipment for high altitude mountaineering expeditions...',
  ...
  return (
    <div className={clsx("search-enhanced relative w-full max-w-2xl", className)}>
      {/* Search Input */}
                  ...
                  {suggestions.map((suggestion, index) => (
                    ...
                    >
                      <div className={clsx(
                        ...
                        suggestion.type === 'completion' && "text-glacierBlue"
                      )}>
                        {suggestion.icon}
                      </div>
