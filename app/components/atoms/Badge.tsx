    ...
    <div
      className={cn(
        ...
        // Color variants
        {
          ...
          'text-foreground border-input bg-background hover:bg-accent hover:text-accent-foreground': variant === 'outline',
          'bg-alpine-blue text-white hover:bg-alpine-blue/80': variant === 'summit'
        },
        className
      )}
      {...props}
