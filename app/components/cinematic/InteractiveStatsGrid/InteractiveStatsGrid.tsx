...
import { Mountain, Calendar, MapPin, Trophy, Clock, Target } from 'lucide-react'
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-xl text-slate-600 max-w-2xl mx-auto">
            Every summit tells a story. Every challenge shapes character. 
            Here's the quantified journey of pursuing the Seven Summits.
          </p>
        </motion.div>
        ...
        >
          <p className="text-lg text-slate-600 mb-8">
            Each number represents countless hours of training, preparation, and determination
          </p>
          <motion.div
