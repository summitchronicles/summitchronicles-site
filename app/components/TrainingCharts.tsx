...
import { TrendingUp, Calendar, Target, Activity, BarChart3, Heart, Mountain, Clock, Zap, Loader2, RefreshCw } from 'lucide-react'
        ...
        <svg width="100%" height="100%" className="overflow-hidden">
          ...
          <defs>
            <linearGradient id={gradientId} x1="0%" y1="0%" x2="0%" y2="100%">
              ...
              <stop offset="100%" stopColor={`var(--color-${color})`} stopOpacity={0.05} />
            </linearGradient>
          </defs>
      ...
      <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-8 border border-spa-stone/10 shadow-sm">
        <div className="flex items-center justify-center space-y-4">
          <div className="flex items-center gap-3 text-spa-charcoal/70">
            ...
            <span className="text-lg font-medium">Loading training data...</span>
          </div>
        </div>
      </div>
    )
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-3xl font-light text-spa-charcoal mb-2">Training Analytics</h2>
          <p className="text-spa-charcoal/70">Real-time performance insights from recent activities</p>
        </div>
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}
        >
          <RefreshCw className={`w-4 h-4 ${refreshing ? 'animate-spin' : 'group-hover:rotate-180'} transition-transform text-alpine-blue`} />
          <span className="text-sm font-medium text-spa-charcoal">Sync Data</span>
        </motion.button>
      </div>
      ...
      {activities.length === 0 && (
        <div className="text-center py-12">
          ...
          <h3 className="text-lg font-medium text-spa-charcoal/70 mb-2">No training data available</h3>
          <p className="text-spa-charcoal/50 mb-6">Connect your Strava account to see your training analytics</p>
