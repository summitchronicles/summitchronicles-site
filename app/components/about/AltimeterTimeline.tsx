            ...
            >
              ...
              <div className="w-full md:w-1/2 pl-12 md:pl-0 md:px-12 text-left md:text-right">
                <div className={`md:${isLeft ? 'text-right' : 'text-left'}`}>
                  ...
                  <h3
                    className={`text-2xl font-oswald tracking-wider font-light mb-1 ${isDone ? 'text-white' : 'text-gray-500'}`}
                  >
                    {exp.mountain}
                  </h3>
                  <div
                    className={`text-sm tracking-widest uppercase mb-4 ${isDone ? 'text-gray-400' : 'text-gray-600'}`}
                  >
              ...
              <div className="absolute left-[11px] md:left-1/2 transform md:-translate-x-1/2 flex items-center justify-center">
                <div
                  className={`w-5 h-5 rounded-full border-2 z-10 ${isDone ? 'bg-black border-summit-gold-500' : 'bg-black border-gray-700'}`}
                >
                  {isDone && (
