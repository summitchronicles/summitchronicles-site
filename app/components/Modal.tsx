      ...
      <div className="text-center space-y-6">
        ...
        <div>
          ...
          <p className="text-slate-600 leading-relaxed">
            Follow my personal journey to Mount Everest. Get weekly updates on my training progress, 
            gear testing, and preparation insights straight from the mountains.
          </p>
        </div>
        ...
        {success ? (
          <div className="space-y-4">
            ...
            <div>
              <h4 className="text-lg font-semibold text-slate-900 mb-2">Welcome aboard!</h4>
              <p className="text-slate-600">You'll receive your first update soon.</p>
            </div>
          </div>
        ) : (
          /* Newsletter Form */
...
export function StravaConnectModal({ isOpen, onClose }: StravaConnectModalProps) {
  return (
    <Modal 
      isOpen={isOpen} 
      onClose={onClose}
      ...
      <div className="space-y-6">
        ...
        <div className="bg-slate-50 rounded-xl p-4">
          ...
          <p className="text-sm text-slate-600 leading-relaxed">
            ...
            Your data remains secure and is never shared with third parties.
          </p>
        </div>
