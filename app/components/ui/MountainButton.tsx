...
export default function MountainButton({
  ...
  const baseClasses = clsx(
    ...
    {
      // Primary - Alpine Blue
      'bg-alpineBlue text-snowWhite shadow-lg hover:shadow-xl': variant === 'primary',
      'hover:bg-blue-700': variant === 'primary' && !disabled,
      
      // Secondary - Light with border
      'bg-snowWhite text-alpineBlue border-2 border-alpineBlue shadow-md': variant === 'secondary',
      'hover:bg-alpineBlue hover:text-snowWhite': variant === 'secondary' && !disabled,
      
      // Accent - Summit Gold
      'bg-summitGold text-charcoal shadow-lg hover:shadow-xl': variant === 'accent',
      'hover:bg-yellow-400': variant === 'accent' && !disabled,
      
      // Ghost - Transparent
      'bg-transparent text-alpineBlue hover:bg-alpineBlue hover:text-snowWhite': variant === 'ghost' && !disabled,
      'border border-alpineBlue': variant === 'ghost',
      
      // Gradient - Mountain gradient
      'bg-gradient-to-r from-alpineBlue to-glacierBlue text-snowWhite shadow-lg': variant === 'gradient',
      'hover:from-blue-700 hover:to-blue-500': variant === 'gradient' && !disabled,
    },
