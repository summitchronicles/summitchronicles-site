...
const TrainingProgressionAnalytics = lazy(() =>
  import('../components/organisms/TrainingProgressionAnalytics').then(
    (module) => ({
...
export default function TrainingPage() {
  ...
  const progressInView = useInView(progressRef, {
    once: true,
    margin: '-50px',
  });
  ...
  const trainingPhases = [
    {
      ...
      status: 'completed',
      duration: '12 weeks',
      description: 'Cardiovascular foundation and endurance base',
    },
    {
      name: 'Strength Phase',
      progress: 85,
      status: 'in-progress',
      duration: '8 weeks',
      description: 'Power development and functional strength',
    },
    {
      name: 'Peak Training',
      progress: 0,
      status: 'upcoming',
      duration: '6 weeks',
      description: 'High-intensity expedition-specific training',
    },
    {
      ...
      status: 'upcoming',
      duration: '4 weeks',
      description: 'Final preparations and gear testing',
    },
  ];
          ...
          <div className="max-w-6xl mx-auto px-6 relative">
            ...
            >
              ...
              <motion.p
                ...
                variants={itemVariants}
              >
                Systematic preparation for the Seven Summits challenge through
                evidence-based training methodologies, altitude-specific
                conditioning, and comprehensive performance tracking across all
                seven continents.
              </motion.p>
            ...
            >
              {weeklyStats.map(
                (
                  { label, value, icon: Icon, change, trend, detail },
                  index
                ) => (
                  <motion.div
                    key={label}
                  ...
                  >
                    ...
                    <div>
                      <div className="text-sm font-medium text-spa-charcoal mb-1">
                        {label}
                      </div>
          ...
          <div className="max-w-6xl mx-auto px-6 relative">
            ...
            >
              ...
              <p className="text-lg text-spa-charcoal/70 max-w-2xl mx-auto">
                Multi-phase systematic approach to Seven Summits challenge with
                continent-specific preparation
              </p>
            </motion.div>
            ...
            >
              <div className="space-y-8">
                {trainingPhases.map(
                  (
                    { name, progress, status, duration, description },
                    index
                  ) => (
                    <motion.div
                      key={name}
                    ...
                    >
                      ...
                      <div className="flex-1">
                        <div className="flex items-start justify-between mb-4">
                          <div className="flex-1">
                            <h3 className="text-xl font-medium text-spa-charcoal mb-2 group-hover:text-alpine-blue transition-colors">
                              {name}
                            </h3>
                            <div className="flex items-center gap-4 text-sm text-spa-charcoal/60 mb-2">
                              <span className="px-2 py-1 bg-spa-stone/20 rounded-full">
                                Phase {index + 1} of 4
                              </span>
                          ...
                          <div className="text-right ml-6">
                            ...
                            <div
                              className={cn(
                                ...
                                status === 'in-progress' &&
                                  'text-alpine-blue bg-alpine-blue/10',
                                status === 'upcoming' &&
                                  'text-spa-charcoal/60 bg-spa-stone/20'
                              )}
                            >
                        ...
                        <div className="w-full bg-spa-stone/20 rounded-full h-4 overflow-hidden shadow-inner">
                          <motion.div
                            className={cn(
                              ...
                              status === 'in-progress' &&
                                'bg-gradient-to-r from-alpine-blue to-alpine-blue/80',
              ...
              >
                <div className="text-center">
                  <div className="text-sm text-spa-charcoal/60 mb-2">
                  ...
                  <div className="text-sm text-spa-charcoal/70">
                    All seven continents conquered through systematic
                    preparation
                  </div>
                </div>
              </motion.div>
          ...
          <div className="max-w-6xl mx-auto px-6">
            <div className="text-center mb-12">
              ...
              <p className="text-spa-charcoal/70">
                Comprehensive skill development across all mountaineering
                domains
              </p>
            </div>
          ...
          <div className="max-w-6xl mx-auto px-6">
            ...
            >
              ...
              <p className="text-lg text-spa-charcoal/70 max-w-3xl mx-auto">
                Visual proof of systematic training methodology in action. See
                how data-driven preparation translates into measurable
            ...
            <div className="bg-gradient-to-br from-summit-gold/10 to-alpine-blue/10 rounded-xl p-8 border border-spa-stone/10">
              <div className="text-center">
                ...
                <p className="text-spa-charcoal/70 max-w-3xl mx-auto mb-6">
                  Every training session is documented and analyzed for
                  continuous improvement. This systematic approach creates
                  compelling content for brand partnerships while driving real
                  performance gains.
                </p>
                ...
                <div className="animate-pulse space-y-8">
                  ...
                  <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {[1, 2, 3].map((i) => (
                      <div
                        key={i}
                        className="h-64 bg-spa-stone/20 rounded-xl"
                      ></div>
                    ))}
                  </div>
                </div>
