      ...
      <main id="main-content" className="flex-1 pt-16">
        <div className="min-h-screen py-8">
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              <h1 className="text-4xl font-light text-spa-charcoal mb-2">Real-time Training Dashboard</h1>
              ...
              <div className="flex items-center space-x-2 text-sm">
                {isConnected ? (
                  <>
                    ...
                    <span className="text-green-600">Connected to Strava</span>
                  </>
                ) : (
                  <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <div className="bg-white rounded-xl p-6 shadow-spa-soft">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-2xl font-bold text-spa-charcoal">{metrics.totalActivities}</span>
              </div>
              <h3 className="font-medium text-spa-charcoal">Total Activities</h3>
              <p className="text-sm text-spa-charcoal/60">This training cycle</p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-spa-soft">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-2xl font-bold text-spa-charcoal">{metrics.totalDistance}km</span>
              </div>
              <h3 className="font-medium text-spa-charcoal">Distance Covered</h3>
            ...
            <div className="bg-white rounded-xl p-6 shadow-spa-soft">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-2xl font-bold text-spa-charcoal">{metrics.totalElevation.toLocaleString()}m</span>
              </div>
              <h3 className="font-medium text-spa-charcoal">Elevation Gain</h3>
            ...
            <div className="bg-white rounded-xl p-6 shadow-spa-soft">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-2xl font-bold text-spa-charcoal">{metrics.totalTime}h</span>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            <div className="bg-white rounded-xl p-6 shadow-spa-soft">
              <h3 className="text-lg font-medium text-spa-charcoal mb-4">Weekly Progress</h3>
              <div className="space-y-4">
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm text-spa-charcoal/70">Distance Goal</span>
                    <span className="text-sm font-medium text-spa-charcoal">{metrics.weeklyProgress}%</span>
                  </div>
            ...
            {metrics.lastActivity && (
              <div className="bg-white rounded-xl p-6 shadow-spa-soft">
                <h3 className="text-lg font-medium text-spa-charcoal mb-4">Latest Activity</h3>
                <div className="space-y-3">
                  <div>
                    <h4 className="font-medium text-spa-charcoal">{metrics.lastActivity.name}</h4>
                    <p className="text-sm text-spa-charcoal/60">
                      {new Date(metrics.lastActivity.date).toLocaleDateString()}
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-3 gap-4 pt-3 border-t border-gray-100">
                    ...
                    <div className="text-center">
                      ...
                      <p className="text-xs text-spa-charcoal/60">Elevation</p>
                    </div>
                    <div className="text-center">
                      <p className="text-lg font-bold text-spa-charcoal">{metrics.lastActivity.type}</p>
          ...
          <div className="bg-white rounded-xl shadow-spa-soft overflow-hidden">
            <div className="p-6 border-b border-gray-100">
              <div className="flex items-center justify-between">
                <h2 className="text-xl font-medium text-spa-charcoal">Advanced Analytics</h2>
                {lastUpdated && (
                  <p className="text-sm text-spa-charcoal/60">
          ...
          <div className="mt-8 bg-gradient-to-r from-alpine-blue/5 to-summit-gold/5 rounded-xl p-6">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <h3 className="text-lg font-medium text-spa-charcoal">Phase 3 Real-time Features</h3>
            </div>
            
            <div className="grid md:grid-cols-3 gap-4 text-sm">
              <div className="flex items-center space-x-2">
                <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></div>
                <span className="text-spa-charcoal/70">Live Strava integration</span>
              </div>
              <div className="flex items-center space-x-2">
                <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></div>
                <span className="text-spa-charcoal/70">Auto-refreshing metrics</span>
              </div>
              <div className="flex items-center space-x-2">
                <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></div>
                <span className="text-spa-charcoal/70">Training insights AI</span>
              </div>
            </div>
          </div>
        </div>
