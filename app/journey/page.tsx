  ...
  const sevenSummits = [
    {
      ...
      progress: 75,
      description:
        'The ultimate challenge. Currently in intensive training phase.',
      challenges: [
        'Extreme altitude',
        'Death zone exposure',
        'Weather windows',
      ...
      preparation:
        '6-month intensive training program with high-altitude simulation',
    ...
    },
    {
      ...
      progress: 0,
      description:
        'The coldest and most technically demanding of the Seven Summits.',
    ...
    },
    {
      ...
      progress: 0,
      description:
        'The highest peak outside of Asia, known for extreme weather.',
    ...
    },
    {
      ...
      progress: 0,
      description:
        "Africa's highest peak and the world's largest free-standing mountain.",
      challenges: [
    ...
    },
    {
      ...
      progress: 0,
      description:
        'The most technical of the Seven Summits, requiring rock climbing skills.',
      challenges: [
  ...
  const completedSummits = [
    {
      ...
      date: 'September 2022',
      description:
        'My first serious high-altitude experience. Learned the importance of proper acclimatization.',
      lessons: [
    ...
    },
    {
      ...
      date: 'November 2023',
      description:
        'First glacier experience with technical rope team skills and crevasse rescue training.',
      lessons: [
        'Teamwork is essential',
        'Technical skills save lives',
    ...
    },
    {
      ...
      date: 'January 2024',
      description:
        'Winter ascent in challenging conditions. Built confidence for bigger objectives.',
      lessons: [
        'Winter conditions multiply difficulty',
  ...
  const expeditionCosts = [
    {
      ...
      icon: Backpack,
      description:
        'Technical mountaineering gear, safety equipment, clothing systems',
      items: [
    ...
    },
    {
      ...
      icon: Plane,
      description:
        'International flights, permits, transportation, accommodation',
      items: [
        'Flight to Kathmandu/Lhasa',
        'Everest permit',
    ...
    },
    {
      ...
      icon: Mountain,
      description:
        'Professional mountain guides, Sherpa support, expedition services',
      items: [
        'Expedition guide fees',
        'Sherpa support',
        'Oxygen and mask',
        'Weather forecasting',
      ],
          ...
          <div className="max-w-4xl mx-auto px-6 text-center space-y-6 relative z-10">
            ...
            >
              ...
              <BodyLarge className="text-white/90 max-w-2xl mx-auto mt-4">
                Follow my systematic progression through the Seven Summits - the
                highest peaks on each continent. Real training data, honest
                challenges, and the path to Mount Everest.
              </BodyLarge>
            </motion.div>
          ...
          <div className="max-w-6xl mx-auto px-6">
            ...
            >
              ...
              <Body className="max-w-3xl mx-auto text-spa-charcoal/80">
                89 days until departure. Every workout, every decision, every
                piece of gear is optimized for success on the world's highest
                mountain.
              </Body>
            </motion.div>
                    ...
                    {trainingMilestones.map((milestone, index) => (
                      <div key={index} className="flex items-center space-x-4">
                        ...
                        <div className="flex-1">
                          <div
                            className={`text-sm font-medium ${milestone.completed ? 'text-spa-charcoal' : 'text-spa-charcoal/60'}`}
                          >
                ...
                >
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="text-center space-y-2">
                      <div className="text-2xl font-bold text-alpine-blue">
                        127km
                      </div>
                    ...
                    <div className="text-center space-y-2">
                      <div className="text-2xl font-bold text-summit-gold">
                        2,840m
                      </div>
                      <div className="text-sm text-spa-charcoal/70">
                        Elevation Gained
        ...
        <section className="py-16 bg-gradient-to-br from-white to-spa-mist/20">
          <div className="max-w-6xl mx-auto px-6">
            ...
            >
              ...
              <Body className="max-w-3xl mx-auto text-spa-charcoal/80">
                Transparency matters. Here's exactly what it takes to safely
                attempt Mount Everest - each investment ensures proper
              ...
              >
                <div className="text-center">
                  ...
                  <div className="text-xs text-spa-charcoal/60 mt-2">
                    ~$40,000 USD
                  </div>
                </div>
              </motion.div>
                ...
                return (
                  ...
                  >
                    <Card
                      variant="elevated"
                      padding="lg"
                      className="h-full space-y-4 hover:shadow-lg transition-shadow"
                    >
                      <div className="flex items-center justify-between">
                      ...
                      <div className="space-y-2">
                        <div className="text-xs font-medium text-spa-charcoal/70">
                          Includes:
                        </div>
                        <div className="grid grid-cols-1 gap-1">
                          {cost.items.map((item, i) => (
                            <div
                              key={i}
                              className="text-xs text-spa-charcoal/60 flex items-center space-x-2"
                            >
              ...
              <div className="text-center space-y-6">
                <div className="space-y-2">
                  ...
                  <Body className="text-spa-charcoal/70 max-w-2xl mx-auto">
                    Every rupee goes toward safety, preparation, and increasing
                    the chances of success. This isn't just about reaching the
                    summit - it's about coming home safely.
                  </Body>
                </div>
                ...
                <div className="pt-4">
                  <Body className="text-sm text-spa-charcoal/60 italic">
                    ...
                    preparation does. Every investment in safety and training is
                    an investment in coming home." - Sunith Kumar
                  </Body>
                </div>
              </div>
            </motion.div>
        ...
        <section className="py-16">
          <div className="max-w-6xl mx-auto px-6">
            ...
            >
              ...
              <Body className="max-w-3xl mx-auto text-spa-charcoal/80">
                Each mountain teaches different lessons. Here's my systematic
                approach to conquering the highest peaks on each continent.
              </Body>
            </motion.div>
                ...
                {completedSummits.map((summit, index) => (
                  ...
                  >
                    <Card
                      variant="elevated"
                      padding="lg"
                      className="h-full space-y-4 border-l-4 border-l-green-500"
                    >
                      <div className="space-y-2">
                        <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-2 text-sm text-spa-charcoal/60">
                          ...
                          <span>
                            {summit.location} • {summit.elevation}
                          </span>
                        </div>
                        <div className="flex items-center space-x-2 text-sm text-spa-charcoal/60">
                      ...
                      <div className="space-y-3 pt-2 border-t border-spa-stone/20">
                        <div>
                          <div className="text-xs font-medium text-spa-charcoal/70 mb-1">
                            Key Lessons:
                          </div>
                          <div className="space-y-1">
                            {summit.lessons.map((lesson, i) => (
                              <div
                                key={i}
                                className="text-xs text-spa-charcoal/60"
                              >
                                • {lesson}
                              </div>
                            ))}
                    ...
                    >
                      <div className="grid md:grid-cols-3 gap-6">
                        ...
                        <div className="space-y-4">
                          ...
                          <div>
                            <div className="text-sm font-medium text-spa-charcoal/70 mb-2">
                              Key Challenges:
                            </div>
                            <div className="space-y-1">
          ...
          <div className="max-w-4xl mx-auto px-6 text-center space-y-8">
            ...
            >
              ...
              <BodyLarge className="max-w-2xl mx-auto text-white/90">
                Follow my real-time training, share in the challenges and
                victories, and help make this Seven Summits journey possible.
              </BodyLarge>
            </motion.div>
            ...
            >
              ...
              <Button
                variant="ghost"
                size="lg"
                className="w-full text-white border-white hover:bg-white hover:text-alpine-blue"
                asChild
              >
                <Link href="/insights">
