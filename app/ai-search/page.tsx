        ...
        <div className="min-h-screen gradient-peak py-8">
          ...
          <div className="text-center mb-12">
            <div className="flex items-center justify-center space-x-3 mb-4">
              ...
              <h1 className="text-4xl font-bold text-spa-charcoal">AI Training Assistant</h1>
            </div>
            <p className="text-xl text-spa-charcoal/70 max-w-3xl mx-auto mb-8">
              Get instant, expert-level answers to your mountaineering and training questions. 
              Powered by local AI and curated knowledge from climbing experts.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-12">
              <div className="bg-white/60 backdrop-blur-sm rounded-xl p-6 shadow-spa-soft">
                ...
                <h3 className="text-lg font-semibold text-spa-charcoal mb-2">Semantic Search</h3>
                <p className="text-spa-charcoal/70 text-sm">
                  Find relevant training content using natural language queries
                </p>
              </div>
              ...
              <div className="bg-white/60 backdrop-blur-sm rounded-xl p-6 shadow-spa-soft">
                ...
                <h3 className="text-lg font-semibold text-spa-charcoal mb-2">AI Assistant</h3>
                <p className="text-spa-charcoal/70 text-sm">
              ...
              <div className="bg-white/60 backdrop-blur-sm rounded-xl p-6 shadow-spa-soft">
                ...
                <h3 className="text-lg font-semibold text-spa-charcoal mb-2">Knowledge Base</h3>
                <p className="text-spa-charcoal/70 text-sm">
                  Access curated mountaineering knowledge and training protocols
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 mb-12">
            <div className="bg-white rounded-xl p-8 shadow-spa-soft">
              <h2 className="text-2xl font-light text-spa-charcoal mb-6">How It Works</h2>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-medium text-spa-charcoal mb-1">Choose Your Mode</h4>
                    <p className="text-spa-charcoal/70 text-sm">
                      Select between semantic search or AI assistant based on your needs
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-medium text-spa-charcoal mb-1">Ask Your Question</h4>
                    <p className="text-spa-charcoal/70 text-sm">
                      Type your mountaineering or training question in natural language
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-medium text-spa-charcoal mb-1">Get Expert Answers</h4>
                    <p className="text-spa-charcoal/70 text-sm">
                      Receive detailed, safety-focused responses backed by mountaineering expertise
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white rounded-xl p-8 shadow-spa-soft">
              <h2 className="text-2xl font-light text-spa-charcoal mb-6">Knowledge Areas</h2>
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  <div key={index} className="p-3 bg-spa-stone/10 rounded-lg">
                    <span className="text-sm font-medium text-spa-charcoal">{area}</span>
                  </div>
                ))}
              </div>
              ...
              <div className="mt-6 p-4 bg-blue-50 rounded-lg">
                <p className="text-sm text-blue-800">
                  <strong>Privacy Note:</strong> All processing happens locally using Ollama. 
