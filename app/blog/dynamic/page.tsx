        ...
        setPosts([
          {
            ...
            excerpt:
              'Preparing for the ultimate climbing challenge requires months of dedicated training and preparation.',
          ...
          },
          {
            ...
            excerpt:
              'Learn the essential skills needed for successful alpine climbing adventures.',
          ...
          },
          {
            ...
            excerpt:
              'A comprehensive review of essential winter climbing gear and equipment.',
          ...
          <div className="max-w-6xl mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-slate-600 max-w-2xl mx-auto">
                Stories, insights, and lessons learned on the path to
                extraordinary peaks.
                {posts.length > 3 &&
                  ' Now featuring dynamic content from our CMS.'}
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="mountain-card p-8 elevation-shadow text-center">
                ...
                <p className="text-slate-600 mb-6">
                  Get exclusive training insights, expedition updates, and gear
                  reviews delivered weekly.
                </p>
                <button
